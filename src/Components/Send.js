    ...
    <div className='flex flex-col justify-center items-center text-white'>
      ...
      {/* ERC20 Address*/}
        ...
        <div  className='flex w-4/5 justify-between items-center mt-5'>
          <input onChange={(e)=> App.setRecipientAddress(e.target.value)} value= {App.recipientAddress} className='w-3/4 p-3 bg-black border-2 border-blue-900 border-opacity-60 bg-opacity-70 outline-none rounded-lg' placeholder='Recipient Address' />

          <input onChange={(e)=> App.setAmount(e.target.value)} value= {App.amount} className='w-1/4 p-3 bg-black border-2 border-blue-900 border-opacity-60 bg-opacity-70 outline-none rounded-lg ml-2' type={"number"} placeholder='Amount' />
        ...
        { App.txLoading?
          <div className={'flex mt-4 w-4/5 cursor-pointer justify-center items-center p-2 bg-green-700 bg-opacity-70 border-2 border-blue-900 border-opacity-80 text-xl font-medium rounded-lg'}>
            <Bars width={40} height={46} color={'white'} />
          </div>
        :
        ...
        {/* Recent Tx */}
        <div className={`${App.showRecentTx? ' ':'hidden'} bg-black rounded-lg bg-opacity-60 bordere-2 border-blue-900 border-opacity-80 w-4/5 mt-2`}>
